...
export const HomeHero = () => {
  return (
    <section className="relative overflow-hidden text-white">
      ...
      <div className="absolute inset-y-0 right-0 w-1/2 bg-[radial-gradient(circle_at_center,rgba(201,162,39,0.3),transparent_65%)] blur-3xl" aria-hidden />
      <div className="container relative grid gap-10 py-20 md:grid-cols-[1.2fr_0.8fr] md:items-center">
        <div className="space-y-6">
          <p className="inline-flex items-center gap-2 rounded-full border border-white/40 bg-white/10 px-5 py-1 text-xs uppercase tracking-[0.3em] text-brand-gold shadow-glow">
        ...
        <div className="glass-panel md:ml-auto">
